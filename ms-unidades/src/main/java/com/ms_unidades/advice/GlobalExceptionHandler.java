package com.ms_unidades.advice;

import com.ms_unidades.errors.ApiErrors;
...
@ControllerAdvice//Activa el mecanismo de control global de excepciones
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleBusinessException(BusinessException ex) {
        ...
        return ResponseEntity.status(HttpStatus.valueOf(422)).body(errores);
    }
